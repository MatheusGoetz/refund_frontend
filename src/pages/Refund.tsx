...
const refundSchema = z.object({
	...
	amount: z.coerce
		...
		.positive({ message: "O valor deve ser positivo e superior a zero" }),
});
...
export function Refund() {
	...
	async function onSubmit(e: React.FormEvent) {
		...
		try {
			...
			if (!filename) {
				return alert("Seleciona um arquivo de comprovante");
			}
		...
		>
			...
			{params.id && fileURL ? (
				<a
					...
					target="_blank"
					className="text-sm text-green-100 flex items-center justify-center gap-2 my-6 hover:opacity-70 transition ease-linear"
				>
